    async function addTextVocabulary(e) {
      ...
      if(!supabaseClient){ notify('Supabase is not available. Please refresh the page and try again.'); return; }
      ...
      try {
        ...
        notify('Text vocabulary added to the online database!');
        switchTab('text-study');
      } catch(error) {
        console.error('Text vocabulary insert failed:',error);
        notify('Could not save the text vocabulary. Please check the text_vocabs policies.');
